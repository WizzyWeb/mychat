...
CHATWOOT_HUB_URL="https://hub.2.chatmy.ae/events"
...
Join the community at https://chatmy.ae/community?utm_source=cwctl
***************************************************************************
...
function get_cw_version() {
  CW_VERSION=$(curl -s https://app.chatmy.ae/api | python3 -c 'import sys,json;data=json.loads(sys.stdin.read()); print(data["version"])')
}
...
https://www.chatmy.ae/docs/deployment/deploy-chatwoot-in-linux-vm?utm_source=cwctl
...
Get help, https://chatmy.ae/community?utm_source=cwctl
